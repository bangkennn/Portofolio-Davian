  ...
  return (
    <section className="py-20 px-4 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 auto-rows-[180px]">
        ...
        <SpotlightCard className="md:col-span-1 md:row-span-2 bg-zinc-900/50 flex flex-col overflow-hidden">
        ...
        {/* 4. ACHIEVEMENTS */}
        <SpotlightCard className="md:col-span-1 md:row-span-1 bg-zinc-900/50 p-6 flex flex-col justify-between overflow-hidden min-h-[320px]">
        ...
        {/* 6. SERVICES */}
        <SpotlightCard className="md:col-span-2 md:row-span-1 bg-zinc-900/50 p-6 flex flex-col justify-center relative group overflow-hidden min-h-[320px]">
